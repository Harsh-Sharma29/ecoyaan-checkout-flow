...
export default function SuccessPage() {
  ...
  useEffect(() => {
    if (hydrated && !orderPlaced) router.replace("/");
  ...
  // Clear localStorage once order is successfully placed
  useEffect(() => {
    if (hydrated && orderPlaced) {
      clearPersistedState();
    }
  }, [hydrated, orderPlaced, clearPersistedState]);

  if (!hydrated || !orderPlaced || !cart || !shippingAddress) {
    return (
