...
export default function PaymentPage() {
  const { cart, shippingAddress, placeOrder } = useCheckout();
    ...
    <div className="animate-fade-in-up">
      ...
      <div className="mt-6 max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-2xl border border-gray-100 bg-white/70 backdrop-blur-md p-5">
        ...
        <div>
          <div className="sticky top-24 rounded-2xl border border-gray-100 bg-white/70 backdrop-blur-md p-6 space-y-5">
            ...
            <div className="rounded-xl bg-gradient-to-br from-gray-900 to-gray-700 p-5 text-white relative overflow-hidden">
              ...
              <p className="text-xs uppercase tracking-widest text-gray-400 mb-4">Payment Method</p>
            ...
            <button
              ...
              onClick={handlePay}
              disabled={processing}
              className="w-full rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 px-6 py-3.5 text-sm font-bold text-white shadow-lg shadow-emerald-500/25 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/30 hover:from-emerald-600 hover:to-teal-600 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 cursor-pointer"
            >
              {processing ? (
                <>
      ...
      <button
        ...
        className="mt-6 flex items-center gap-1 text-sm text-gray-400 hover:text-emerald-600 transition-colors mx-auto cursor-pointer"
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
